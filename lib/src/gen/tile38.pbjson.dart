...
const Hook$json = const {
  '1': 'Hook',
  '2': const [
    const {'1': 'hookName', '3': 1, '4': 1, '5': 9, '10': 'hookName'},
    const {'1': 'group', '3': 2, '4': 1, '5': 9, '10': 'group'},
    const {'1': 'command', '3': 3, '4': 1, '5': 14, '6': '.Command', '10': 'command'},
    const {'1': 'area', '3': 4, '4': 1, '5': 11, '6': '.Area', '10': 'area'},
  ],
};
...
const Packet$json = const {
  ...
  '2': const [
    ...
    const {'1': 'getHooks', '3': 5, '4': 1, '5': 11, '6': '.GetHooks', '9': 0, '10': 'getHooks'},
    const {'1': 'hooks', '3': 6, '4': 1, '5': 11, '6': '.HookList', '9': 0, '10': 'hooks'},
  ],
  '8': const [
    const {'1': 'data'},
  ],
